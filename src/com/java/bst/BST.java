 ...
 *  Execution:    java BST
 *  Dependencies: System.in.java System.out.java Queue.java
    ...
    ***************************************************************************/
    ...
    public static void main(String[] args) { 
        ...
        for (Integer i = 0; i < n; i++) {
            Integer key = ThreadLocalRandom.current().nextInt(0, 100);
            if ((st.size() > 1) && (st.floor(key) != st.floor2(key)))
                throw new RuntimeException("floor() function inconsistent");
            st.put(key, ThreadLocalRandom.current().nextInt(1000, 10000));
        }
